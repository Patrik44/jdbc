...
public class TaskServicesImpl implements TaskServices {
    ...
    @Override
    public Task vratTask(Integer id) {
        final String sql = "select * form tasks where task.id =" + id;
        try {
    ...
    @Override
    public Integer pridajTask(Task task) {
    ...
    @Override
    public void aktualizujTask(Integer id, Task task) {
    ...
    @Override
    public void vymazTask(Integer id) {
    ...
    @Override
    public void vymazTask2(Integer id) {
